...
class BamlAsyncClient:
    ...
    async def ExtractImg(self, myFile: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> types.OCRResult:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.ExtractImg(myFile=myFile,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractImg", args={
                "myFile": myFile,
            })
            return typing.cast(types.OCRResult, result.cast_to(types, types, stream_types, False, __runtime__))
    async def ExtractPDF(self, myFile: baml_py.Pdf,
        baml_options: BamlCallOptions = {},
    ) -> types.OCRResult:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.ExtractPDF(myFile=myFile,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractPDF", args={
                "myFile": myFile,
            })
            return typing.cast(types.OCRResult, result.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ExtractImg(self, myFile: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.OCRResult, types.OCRResult]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractImg", args={
            "myFile": myFile,
        })
    ...
    def ExtractPDF(self, myFile: baml_py.Pdf,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.OCRResult, types.OCRResult]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractPDF", args={
            "myFile": myFile,
        })
        return baml_py.BamlStream[stream_types.OCRResult, types.OCRResult](
          result,
...
class BamlHttpRequestClient:
    ...
    async def ExtractImg(self, myFile: baml_py.Image,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractImg", args={
            "myFile": myFile,
        }, mode="request")
        return result
    async def ExtractPDF(self, myFile: baml_py.Pdf,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractPDF", args={
            "myFile": myFile,
        }, mode="request")
        return result
    async def ExtractResume(self, resume: str,
