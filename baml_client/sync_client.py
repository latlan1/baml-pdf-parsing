...
class BamlSyncClient:
    ...
    def ExtractImg(self, myFile: baml_py.Image,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractImg", args={
                "myFile": myFile,
            })
    ...
    def ExtractPDF(self, myFile: baml_py.Pdf,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractPDF", args={
                "myFile": myFile,
            })
            return typing.cast(types.OCRResult, result.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ExtractImg(self, myFile: baml_py.Image,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractImg", args={
            "myFile": myFile,
        })
    ...
    def ExtractPDF(self, myFile: baml_py.Pdf,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractPDF", args={
            "myFile": myFile,
        })
        return baml_py.BamlSyncStream[stream_types.OCRResult, types.OCRResult](
          result,
...
class BamlHttpRequestClient:
    ...
    def ExtractImg(self, myFile: baml_py.Image,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractImg", args={
            "myFile": myFile,
        }, mode="request")
        return result
    def ExtractPDF(self, myFile: baml_py.Pdf,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractPDF", args={
            "myFile": myFile,
        }, mode="request")
        return result
    def ExtractResume(self, resume: str,
